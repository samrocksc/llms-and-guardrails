...
function loadImmutabilityOverrides(immutabilitySettings) {
    ...
    return keepDefault ? [...upgraded, ...getDefaultOverrides()] : upgraded;
}

// eslint-disable-next-line ts/naming-convention -- This is a special var.
const __VERSION__ = "10.0.0";
 ...
 */
const ignoreTypePatternOptionSchema = {
    ignoreTypePattern: {
        type: ["string", "array"],
        items: {
            type: "string",
 ...
 */
function shouldIgnoreTypePattern(node, context, ignoreTypePattern) {
    return (ignoreTypePattern !== undefined &&
